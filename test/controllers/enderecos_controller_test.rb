...
class EnderecosControllerTest < ActionController::TestCase
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post :create, endereco: { bairro: @endereco.bairro, cep: @endereco.cep, cidade: @endereco.cidade, estado: @endereco.estado, numero: @endereco.numero, rua: @endereco.rua }
    end
  ...
  test "should update endereco" do
    patch :update, id: @endereco, endereco: { bairro: @endereco.bairro, cep: @endereco.cep, cidade: @endereco.cidade, estado: @endereco.estado, numero: @endereco.numero, rua: @endereco.rua }
    assert_redirected_to endereco_path(assigns(:endereco))
  end
